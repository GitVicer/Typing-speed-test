...
class Game:
    def __init__(self):
        ...
        self.wpm = 0
        self.end = False
        self.HEAD_C = (255,150,0)
        self.TEXT_C = (240,240,240)
        self.RESULT_C = (255,70,70)
        pygame.init()
        self.open_img = pygame.image.load('opening-image.webp')
    ...
    def show_results(self,screen):
        if(not self.end):
            ...
            #screen.blit (self.time_image,(self.w/2-75,self.h-140))
            self.draw_text(screen,"RESET",self.h-50,50,(10,100,220))
            #print(self.results)
            pygame.display.update()       
